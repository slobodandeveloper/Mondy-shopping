      ...
      <ScrollView>
        <View style={style.container}>
          ...
          <View style={[style.childContainer, style.titleContainer]}>
            <Text style={[style.promotionText, style.mondyText]} styleKey="textColor">{'Mandy’s'}</Text>
          ...
          <View style={[style.childContainer, style.forgotPasswordContainer]}>
            ...
            <ThemedText style={style.forgotPassword} styleKey="textColor" onPress={gotoForgotPassword}>{'Forgot Password?'}</ThemedText>
          </View>
          
          <View style={style.largeContainer} >
            <RoundButton label={'Login'} buttonStyle={{minWidth: 230, width : '100%'}} onPress={submitButton} />
            ...
            <FacebookLoginButton label={'Login with Facebook'} buttonStyle={{minWidth: 230, width : '100%'}} onPress={submitButton} />
            <GoogleLoginButton label={'Login with Google'} buttonStyle={{minWidth: 230, width : '100%'}} onPress={submitButton} />
          </View>
